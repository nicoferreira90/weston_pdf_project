...
- [ ] Missing/empty files and textless PDFs produce clear HTTP 422 errors; unexpected reader failures produce a generic HTTP 500 error without missing-field results.
- [ ] Changing a valid PDF's filename does not change extraction.
